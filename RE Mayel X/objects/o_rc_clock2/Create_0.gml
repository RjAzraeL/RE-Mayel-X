...
time_to_finish=0.4 //seconds up to change room (middle of animation)
...
color[1] = c_purple //color of the circle

rc_rad = max(_height,_width) //the circle has to fill the screen
